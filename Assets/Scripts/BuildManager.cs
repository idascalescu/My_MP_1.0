...
public class BuildManager : MonoBehaviour
{
    ...
    public void BuiltTowerOn(NodeScript node)
    {
        ...
        GameObject tower2 = Instantiate(towerToBuild.tPrefab, node.GetBuildPos(), Quaternion.identity);
        GameObject tower3 = Instantiate(towerToBuild.tPrefab, node.GetBuildPos(), Quaternion.identity);
        node.tower = tower;
